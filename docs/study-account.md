...
**Detailed study account. Preserved from the article draft on September 15, 2026.**

This document retains the longer technical narrative, tables, and accounting
from before the publication edit. Its closing discussion of possible next work
records that earlier position; it is not a current execution plan. See the
[revised article](article-draft.md) and [publication notes](publication-notes.md)
for the current scope. The executed protocols and evidence packages remain the
authoritative records of the experiments.
