...
| Live workers improve on a deterministic solver | Unestablished empirical claim | Pending authorized paid runs and a suitable task | No paid run was needed to implement offline behavior; provider code and fixtures do not establish live results. |
